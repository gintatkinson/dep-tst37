...
### Required Features
- [ ] #12 - [Numeric and Identifier Metrics](https://github.com/gintatkinson/dep-tst37/blob/base-rfc9179-rfc9911/docs/features/feat-04-numeric-metrics.md) (Defines counter/gauge validation constraints)
- [ ] #14 - [Physical Addresses and Structural Identifiers](https://github.com/gintatkinson/dep-tst37/blob/base-rfc9179-rfc9911/docs/features/feat-06-physical-structural.md) (Defines MAC/UUID/address validation constraints)
